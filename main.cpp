    ...
    do {
        ...
        while (fila_1 + fila_2 + fila_3 > 1){ //while que ejecuta el juego.
            ...
            while (quitar_fila < 1 || quitar_fila > 3 || (quitar_fila == 1 && fila_1 == 0) || (quitar_fila == 2 && fila_2 == 0) || (quitar_fila == 3 && fila_3 == 0)) {
                cout << "Por favor, ingrese un numero valido de fila: ";
                cin >> quitar_fila;
            }
            if (quitar_fila == 1) {
                ...
                while (quitar_ficha < 1 || quitar_ficha > fila_1) {
                    cout << "Por favor, ingrese un numero valido de fichas a quitar (1 al " << fila_1 << "): ";
                    cin >> quitar_ficha;
                }
                ...
                while (quitar_ficha < 1 || quitar_ficha > fila_2) {
                    cout << "Por favor, ingrese un numero valido de fichas a quitar (1 al " << fila_2 << "): ";
                    cin >> quitar_ficha;
                }
                fila_2 -= quitar_ficha;
            } else {
                ...
                while (quitar_ficha < 1 || quitar_ficha > fila_3) {
                    cout << "Por favor, ingrese un numero valido de fichas a quitar (1 al " << fila_3 << "): ";
                    cin >> quitar_ficha;
                }
                fila_3 -= quitar_ficha;
            }
